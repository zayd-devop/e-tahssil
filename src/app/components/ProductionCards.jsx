...
export function ProductionCards() {
  ...
  // 🔥 ADAPTATION POUR LES CHECKBOXES
    ...
    <div className="bg-transparent max-w-5xl mx-auto mt-6" dir="rtl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="p-6 space-y-6">
              <div>
                <div className="flex items-center gap-3 mb-3">
                  <label className="block text-base font-bold text-[#003366] text-right">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className={`${inputClassName} appearance-none truncate pl-10 pr-3`}
                  >
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 border-r-4 border-r-[#D4AF37]">
                <p className="text-sm text-gray-600 font-medium mb-5 text-right">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      <span className="absolute top-1/2 -translate-y-1/2 left-4 text-gray-500 font-semibold bg-gray-100 px-2 py-1 rounded text-xs">
                        MAD
                      </span>
                    </div>
                  </div>
          ...
          {/* 🔥 Card 3: Mesures Coercitives & PVs (Design mis à jour) */}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden lg:col-span-2">
            ...
            {/* items-stretch force les deux cadres à avoir exactement la même hauteur */}
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              
              {/* Bloc 1 : Nombre de PVs + Checkboxes */}
              <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 flex flex-col justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-5 items-center mt-1">
                  <input
                    ...
                    name="nombrePVs"
                    min="0"
                    value={formData.nombrePVs}
                    onChange={handleChange}
                    className={`${inputClassName} bg-white sm:w-1/2`}
                  />
              ...
              {/* Bloc 2 : Contrainte (Maintenant 100% symétrique avec le même cadre) */}
              <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 flex flex-col justify-center">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`${inputClassName} font-mono pl-14`}
                  />
                  <span className="absolute top-1/2 -translate-y-1/2 left-4 text-gray-500 font-semibold bg-gray-100 px-2 py-1 rounded text-xs">
                    MAD
                  </span>
